<template>
  ...
  >
    <div
      class="relative flex items-center p-0 overflow-hidden bg-center bg-cover min-h-100-screen"
    >
      <div class="container z-10">
        <div class="flex flex-wrap mt-0 -mx-3">
          ...
          >
            ...
            >
              <div class="border-b-0 rounded-t-2xl">
                <img
                  src="https://vamosmobile.app/scims-v2/dashboard/images/webp/scims_new.webp"
                ...
                <form role="form" method="POST">
                  ...
                  <div class="mb-4">
                    <input
                      ...
                      name="username"
                      id="username"
                      class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-lime-700 focus:outline-none focus:transition-shadow"
                      placeholder="Email"
                      aria-label="Email"
          ...
          <div class="w-full max-w-full px-3 lg:flex-0 shrink-0 md:w-7/12">
            <div
              class="absolute top-0 w-3/5 h-full -mr-32 overflow-hidden -skew-x-10 -right-40 md:block"
            >
              <div
                class="absolute inset-x-0 top-0 z-0 h-full -ml-16 bg-cover skew-x-20"
                style="
                  background-image: url('.././src/assets/cityhall_new1.webp');
                "
              ></div>
            </div>
          </div>
...
.via-black\/40 {
  --tw-gradient-to: rgb(0 0 0 / 0);
  --tw-gradient-stops: var(--tw-gradient-from), rgb(0 0 0 / 0.4),
    var(--tw-gradient-to);
}
...
.shadow-soft-md {
  --tw-shadow: 0 4px 7px -1px rgba(0, 0, 0, 0.11),
    0 2px 4px -1px rgba(0, 0, 0, 0.07);
  --tw-shadow-colored: 0 4px 7px -1px var(--tw-shadow-color),
...
.shadow-soft-3xl {
  --tw-shadow: 0 8px 26px -4px hsla(0, 0%, 8%, 0.15),
...
.shadow-blur {
  --tw-shadow: inset 0 0 1px 1px hsla(0, 0%, 100%, 0.9),
...
.transform-dropdown {
  transform: perspective(999px) rotateX(-10deg) translateZ(0)
    translate3d(0, 37px, 0);
}

.transform-dropdown-show {
  transform: perspective(999px) rotateX(0deg) translateZ(0)
    translate3d(0, 37px, 5px);
}
