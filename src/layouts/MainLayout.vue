<template>
  <q-layout view="hHh lpR fFf" class="select-none">
    <nav
      class="transition-all duration-300 ease-in-out delay-300 bg-gradient-to-tl from-gray-800 to-slate-700 drop-shadow-2xl"
    >
        ...
        <div class="relative flex h-16 items-center justify-between">
          <div class="flex flex-1 sm:items-stretch sm:justify-start">
            <div class="flex flex-shrink-0 items-center">
              <img
                class="block h-9 w-auto lg:hidden"
          ...
          >
            <button
              class="bg-gray-700 dark:bg-gray-700 duration-300 border flex items-center text-xs font-medium text-white rounded-full dark:hover:text-white md:mr-0 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-white"
              type="button"
            ...
            >
              ...
              <img
                class="h-9 w-9 rounded-full mr-1"
                src="https://vamosmobile.app/scims-v2/dashboard/images/scc-logo.ico"
                alt=""
              />
              <svg
                class="relative duration-300 transform focus:rotate-45 focus:outline-none focus:ring focus:ring-violet-300 w-4 h-4 mx-1.5"
                aria-hidden="true"
                fill="currentColor"
                viewBox="0 0 20 20"
            ...
            <div
              class="mt-4 absolute z-[1000] float-left m-10 hidden min-w-max list-none overflow-hidden rounded-lg bg-white bg-clip-padding text-left text-base drop-shadow-md border-black dark:bg-gray-700 [&[data-te-dropdown-show]]:block"
              aria-labelledby="dropdownMenuButton1"
              data-te-dropdown-menu-ref
            >
              <a
                href="./"
                class="hover:scale-110 duration-200 rounded-lg flex px-4 py-2 text-sm text-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
              >
                <svg
                  aria-hidden="true"
              ...
              <button id="signout" name="signout" class="flex w-full">
                <a
                  class="w-full hover:scale-110 duration-200 rounded-lg flex px-4 py-2 text-sm text-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
                >
                  <svg
                    aria-hidden="true"
                    class="w-5 h-5 ml-2 fill-current"
          ...
          <div class="flex bg-white dark:bg-gray-800 rounded-full ml-2">
            <a
              id="theme-switcher"
              class="rounded-full w-10 h-10 flex items-center justify-center whitespace-nowrap bg-transparent px-3 py-2 text-sm font-normal text-gray-700 hover:bg-gray-100 focus:bg-gray-200 focus:outline-none active:text-zinc-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent disabled:text-gray-400 dark:text-gray-100 dark:hover:bg-gray-600 focus:dark:bg-gray-600"
              href="#"
              data-theme="light"
            >
              <svg
            ...
            >
              <q-list class="bg-gray-200">
                ...
                <q-item clickable v-close-popup @click="onItemClick">
                  ...
                  <q-item-section>
                    <q-item-label>Register Account</q-item-label>
                  </q-item-section>
                </q-item>
